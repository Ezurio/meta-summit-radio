...
FILES:${PN}-conf-btattach = " \
    ${sysconfdir}/modprobe.d/moal-btattach.conf \
    "
FILES:${PN}-conf-serdev = " \
...
ALLOW_EMPTY:${PN}-binaries = "1"
ALLOW_EMPTY:${PN}-1216-btattach = "1"
ALLOW_EMPTY:${PN}-1218-btattach = "1"
ALLOW_EMPTY:${PN}-1216-serdev = "1"
ALLOW_EMPTY:${PN}-1218-serdev = "1"

RDEPENDS:${PN}-1216-btattach = "${PN}-firmware-btattach ${PN}-1216-power-tables ${PN}-conf-btattach"
RDEPENDS:${PN}-1218-btattach = "${PN}-firmware-btattach ${PN}-1218-power-tables ${PN}-conf-btattach"
RDEPENDS:${PN}-1216-serdev = "${PN}-firmware-serdev ${PN}-1216-power-tables ${PN}-conf-serdev"
RDEPENDS:${PN}-1218-serdev = "${PN}-firmware-serdev ${PN}-1218-power-tables ${PN}-conf-serdev"
RDEPENDS:${PN}-binaries = "${PN}-1216-power-tables ${PN}-1218-power-tables ${PN}-firmware-serdev ${PN}-firmware-btattach"
